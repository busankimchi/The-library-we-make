import { FocusZoneDirection, FocusZoneProperties, FocusZoneTabbableElements } from '@stardust-ui/accessibility';
 ...
 */
export interface FocusZoneProps extends FocusZoneProperties, React.HTMLAttributes<HTMLElement | FocusZone> {
    /** @docSiteIgnore */
    as?: React.ReactType;
    /**
