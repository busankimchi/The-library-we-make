...
export declare const FOCUSZONE_WRAP_ATTRIBUTE = "data-focuszone-wrap";
/**
 ...
 * @public
 */
export declare function getDocument(rootElement?: Element | null): Document | undefined;
/**
 * Returns parent element of passed child element if exists
 * @param child element to find parent for
 */
export declare function getParent(child: HTMLElement): HTMLElement | null;
/**
