...
var _getPointerStyles = _interopRequireDefault(require("../../getPointerStyles"));

var _pointerSvgUrl = _interopRequireDefault(require("../../pointerSvgUrl"));
...
var tooltipContentStyles = {
  root: function root(_ref) {
    var p = _ref.props,
        v = _ref.variables,
        rtl = _ref.rtl;
    var svgPointerStyles = (0, _getPointerStyles.default)(getPointerOffset(p.placement, v), v.pointerMargin, rtl, p.placement, true);
  ...
  pointer: function pointer(_ref2) {
    ...
    return Object.assign({
      ...
      backgroundImage: (0, _pointerSvgUrl.default)(v.backgroundColor)
...
var _default = tooltipContentStyles;
