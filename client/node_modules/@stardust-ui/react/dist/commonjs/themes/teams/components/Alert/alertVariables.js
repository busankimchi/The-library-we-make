...
var _default = function _default(siteVars) {
  var minHeight = (0, _lib.pxToRem)(28);
  return {
    borderStyle: 'solid',
    borderWidth: '1px',
    borderRadius: (0, _lib.pxToRem)(3),
    ...
    minHeight: minHeight,
    padding: "0 ".concat((0, _lib.pxToRem)(16)),
    actionsMargin: (0, _lib.pxToRem)(5),
    dismissActionSize: minHeight,
    dismissActionColor: undefined,
    dismissiblePadding: "0 0 0 ".concat((0, _lib.pxToRem)(16)),
    ...
    headerMargin: "0 ".concat((0, _lib.pxToRem)(10), " 0 0"),
    iconMargin: "0 ".concat((0, _lib.pxToRem)(10), " 0 0")
  };
};
