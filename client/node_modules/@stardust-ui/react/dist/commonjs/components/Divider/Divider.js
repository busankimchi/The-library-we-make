...
function (_UIComponent) {
  (0, _inherits2.default)(Divider, _UIComponent);
...
(0, _defineProperty2.default)(Divider, "create", void 0);
(0, _defineProperty2.default)(Divider, "className", 'ui-divider');
(0, _defineProperty2.default)(Divider, "propTypes", Object.assign({}, _lib.commonPropTypes.createCommon({
  color: true
}), {
...
Divider.create = (0, _lib.createShorthandFactory)({
  Component: Divider,
  mappedProp: 'content'
});
/**
