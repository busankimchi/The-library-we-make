...
exports.default = exports.mergeBooleanValues = exports.mergeRenderers = void 0;

var _felaRenderer = require("./felaRenderer");

var _mergeThemes = _interopRequireDefault(require("./mergeThemes"));

var registeredRenderers = new WeakMap();

var mergeRenderers = function mergeRenderers(current, next) {
...
var mergeProviderContexts = function mergeProviderContexts() {
  ...
  return contexts.reduce(function (acc, next) {
    if (!next) return acc;
    acc.theme = (0, _mergeThemes.default)(acc.theme, next.theme); // Latest RTL value wins
