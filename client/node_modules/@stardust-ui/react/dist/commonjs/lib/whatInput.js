...
var currentInput = 'initial'; // check for sessionStorage support
...
if ((0, _isBrowser.default)() && 'addEventListener' in window && Array.prototype.indexOf) {
  setUp();
}
/*
 * set up for document
...
var setUpWhatInput = function setUpWhatInput(target) {
  ...
  if ((0, _isBrowser.default)() && targetWindow && 'addEventListener' in targetWindow && Array.prototype.indexOf) {
...
var tryCleanupWhatInput = function tryCleanupWhatInput(target) {
  ...
  if ((0, _isBrowser.default)() && targetWindow && 'removeEventListener' in targetWindow) {
...
var setWhatInputSource = function setWhatInputSource(newInput) {
