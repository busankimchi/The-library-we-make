...
function createShorthandFactory(_ref2) {
...
function createShorthandFromValue(_ref3) {
  ...
  if (defaultProps.styles || overrideProps.styles || usersProps.styles) {
    props.styles = (0, _mergeThemes.mergeStyles)(defaultProps.styles, usersProps.styles, overrideProps.styles);
  } // ----------------------------------------
  // Get key
  // ----------------------------------------
