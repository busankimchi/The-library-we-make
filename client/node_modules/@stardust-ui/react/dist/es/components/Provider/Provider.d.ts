...
import { ComponentVariablesInput, Renderer, ThemeInput } from '../../themes/types';
import { ProviderBoxProps } from './ProviderBox';
...
declare const _default: {
    <Tag>(x: {
        as: Tag;
    } & ProviderProps & ProviderBoxProps & {
        [K: string]: any;
    }): JSX.Element;
    (x: {
        renderer?: Renderer;
        ...
        styles?: import("../../themes/types").ComponentSlotStyle<ProviderBoxProps, any>;
    ...
    Box: {
        ...
        displayName: string;
        className: string;
        create: import("../../lib").ShorthandFactory<WithAsProp<ProviderBoxProps>>;
    };
    Consumer: React.FunctionComponent<import("./ProviderConsumer").ProviderConsumerProps>;
};
