...
import { UIComponentProps, ContentComponentProps, ChildrenComponentProps, ShorthandFactory } from '../../lib';
...
declare const _default: {
    ...
    create: ShorthandFactory<AccordionTitleProps>;
    _handledPropsCache: string[];
    slotClassNames: AccordionTitleSlotClassNames;
};
/**
