...
export var find = function find(data, key, search) {
  var value = data[key];
  return search !== '' && (includes(key, search) || _typeof(value) !== 'object' && !_isNil(value) && includes(value, search));
};
/**
...
export var isOverridden = function isOverridden(data, key, overrides) {
  return _typeof(data[key]) !== 'object' && !!overrides && overrides[key] !== null && overrides[key] !== undefined;
};
/**
...
var filterR = function filterR(search, data) {
  ...
  Object.keys(data).forEach(function (key) {
    ...
    if (_typeof(value) === 'object' && filterR(search, value)) {
      result = true;
    }
  });
  return result;
...
export var removeNulls = function removeNulls(o) {
  ...
  Object.keys(o).forEach(function (k) {
    if (!o[k] || _typeof(o[k]) !== 'object') {
      ...
      if (_typeof(val) === 'object' && val != null && Object.keys(val).length > 0) {
        result[k] = val;
      }
    }
  });
