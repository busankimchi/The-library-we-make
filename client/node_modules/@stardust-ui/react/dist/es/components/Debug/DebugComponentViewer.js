...
var DebugComponentViewer = function DebugComponentViewer(props) {
  ...
  var component = fiberNav.name && React.createElement(DebugLine, null, fiberNav.jsxString);
  return React.createElement(ScrollToBottom, {
    style: style
  }, React.createElement(DebugLine, _extends({
    indent: 0
  ...
  }), ownerNav.jsxString), React.createElement(DebugLine, {
    indent: 1,
    style: {
      color: '#ba645e'
    }
  }, "render()"), parentNavs.map(function (parent, i) {
    return React.createElement(DebugLine, {
      key: i,
      indent: 2 + i,
      actionable: true,
      tabIndex: "0",
