...
declare class FiberNavigator {
    ...
    readonly name: any;
    readonly parent: FiberNavigator;
    readonly owner: FiberNavigator;
    readonly domNode: any;
    readonly instance: any;
    readonly reactComponent: any;
    readonly elementType: any;
    readonly stardustDebug: any;
    readonly jsxString: string;
    isEqual(fiberNav: FiberNavigator): boolean;
    usesHook(name: any): boolean;
    ...
    readonly isHostComponent: boolean;
    readonly isDOMComponent: boolean;
    readonly isCompositeComponent: boolean;
}
