...
function () {
  ...
  _createClass(FiberNavigator, [{
    ...
    key: "usesHook",
    value: function usesHook(name) {
      return this.__fiber._debugHookTypes.some(function (hook) {
        return hook === name;
      });
    }
  }, {
    ...
    key: "instance",
    get: function get() {
      return this.isClassComponent ? this.__fiber.stateNode : this.isFunctionComponent // TODO: assumes functional component w/useRef
      ? this.__fiber.memoizedState && this.__fiber.memoizedState.memoizedState && this.__fiber.memoizedState.memoizedState.current : null;
    }
  }, {
    key: "reactComponent",
    get: function get() {
