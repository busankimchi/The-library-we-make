...
import { StyledComponentProps, ChildrenComponentProps, ShorthandFactory } from '../../lib';
export interface AnimationProps extends StyledComponentProps, ChildrenComponentProps<React.ReactChild> {
...
declare const _default: {
    ...
    create: ShorthandFactory<AnimationProps>;
