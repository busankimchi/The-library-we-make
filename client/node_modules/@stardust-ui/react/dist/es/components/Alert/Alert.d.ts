...
import { UIComponentProps, ContentComponentProps } from '../../lib';
...
declare const _default: {
    ...
    (x: {
        ...
        actions?: string | number | boolean | React.ReactElement<any, string | ((props: any) => React.ReactElement<any, string | any | (new (props: any) => React.Component<any, any, any>)>) | (new (props: any) => React.Component<any, any, any>)> | React.ReactNodeArray | React.ReactPortal | ShorthandValue<ButtonProps & {
            kind?: never;
        }>[] | import("../../types").Props<ButtonGroupProps>;
        icon?: ShorthandValue<IconProps>;
        header?: ShorthandValue<TextProps>;
        attached?: boolean | "top" | "bottom";
        fitted?: boolean;
