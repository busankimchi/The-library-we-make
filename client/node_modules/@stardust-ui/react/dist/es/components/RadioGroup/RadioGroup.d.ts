...
declare const _default: {
    ...
    (x: {
        ...
        items?: import("../../types").ShorthandValue<RadioGroupItemProps & {
            kind?: never;
        }>[];
        vertical?: boolean;
        className?: string;
    ...
    create: ShorthandFactory<RadioGroupProps>;
    ...
    Item: {
        ...
        (x: {
            ...
            label?: import("../../types").ShorthandValue<import("../..").BoxProps>;
            defaultChecked?: boolean;
            disabled?: boolean;
            icon?: import("../../types").ShorthandValue<import("../..").IconProps>;
            name?: string;
        ...
        getAutoControlledStateFromProps: React.GetDerivedStateFromProps<any, any>;
        unhandledProps: string[];
        create: ShorthandFactory<RadioGroupItemProps>;
        _handledPropsCache: string[];
    };
};
/**
