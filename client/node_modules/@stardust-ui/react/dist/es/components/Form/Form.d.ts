...
import { UIComponentProps, ChildrenComponentProps, ShorthandFactory } from '../../lib';
import { ComponentEventHandler, ShorthandCollection } from '../../types';
...
declare const _default: {
    ...
    (x: {
        ...
        action?: string;
        fields?: import("../../types").ShorthandValue<FormFieldProps & {
            kind?: never;
        }>[];
        onSubmit?: ComponentEventHandler<FormProps>;
        className?: string;
    ...
    create: ShorthandFactory<FormProps>;
    _handledPropsCache: string[];
    slotClassNames: FormSlotClassNames;
    Field: {
        <Tag>(x: {
            as: Tag;
        } & FormFieldProps & {
        ...
        (x: {
            accessibility?: Accessibility<any>;
            control?: import("../../types").ShorthandValue<import("../..").BoxProps>;
            id?: string;
            inline?: boolean;
            label?: import("../../types").ShorthandValue<import("../..").TextProps>;
            message?: import("../../types").ShorthandValue<import("../..").TextProps>;
            name?: string;
            required?: boolean;
            type?: string;
            className?: string;
