...
import { AutoControlledComponent, RenderResultConfig, ChildrenComponentProps, ContentComponentProps, StyledComponentProps, ShorthandFactory } from '../../lib';
import { ShorthandValue } from '../../types';
import { BasicPositioningProps, PopperChildrenProps } from '../../lib/positioner';
...
export interface TooltipProps extends StyledComponentProps<TooltipProps>, ChildrenComponentProps, ContentComponentProps<ShorthandValue<TooltipContentProps>>, BasicPositioningProps {
    /**
...
export default class Tooltip extends AutoControlledComponent<TooltipProps, TooltipState> {
    ...
    static Content: {
        ...
        create: ShorthandFactory<TooltipContentProps>;
    ...
    static propTypes: {
        ...
        target: (props: Record<string, any>, propName: string) => Error;
    ...
    getTriggerProps(triggerElement: any): import("../../types").ObjectOf<any>;
    getContentProps: (predefinedProps?: any) => import("../../types").ObjectOf<any>;
    shouldStayOpen: (e: any) => any;
    renderTooltipContent(tooltipPositionClasses: string, rtl: boolean, accessibility: ReactAccessibilityBehavior): JSX.Element;
    renderPopperChildren: (tooltipPositionClasses: string, rtl: boolean, accessibility: ReactAccessibilityBehavior, { placement }: PopperChildrenProps) => JSX.Element;
    trySetOpen(newValue: boolean, eventArgs: any): void;
    setTooltipOpen(newOpen: any, e: any): void;
    scheduleTooltipClose: (e: any) => void;
