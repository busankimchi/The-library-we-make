...
import { UIComponentProps, ContentComponentProps, ChildrenComponentProps } from '../../lib';
...
declare const _default: {
    ...
    (x: {
        ...
        styles?: import("../..").ComponentSlotStyle<BoxProps, any>;
        variables?: any;
    ...
    displayName: string;
    className: string;
    create: import("../../lib").ShorthandFactory<WithAsProp<BoxProps>>;
};
/**
