...
import { UIComponentProps, ContentComponentProps, AutoControlledComponent } from '../../lib';
import { ComponentEventHandler, WithAsProp, ShorthandValue } from '../../types';
...
declare class Dialog extends AutoControlledComponent<WithAsProp<DialogProps>, DialogState> {
    static displayName: string;
    static className: string;
    static slotClassNames: DialogSlotClassNames;
    static propTypes: {
        actions: (props: Record<string, any>, propName: string, componentName: string, ...args: any[]) => any;
        backdrop: PropTypes.Requireable<boolean>;
        headerAction: (props: Record<string, any>, propName: string, componentName: string, ...args: any[]) => any;
        cancelButton: (props: Record<string, any>, propName: string, componentName: string, ...args: any[]) => any;
        closeOnOutsideClick: PropTypes.Requireable<boolean>;
        confirmButton: (props: Record<string, any>, propName: string, componentName: string, ...args: any[]) => any;
        defaultOpen: PropTypes.Requireable<boolean>;
        header: (props: Record<string, any>, propName: string, componentName: string, ...args: any[]) => any;
        onCancel: PropTypes.Requireable<(...args: any[]) => any>;
        onConfirm: PropTypes.Requireable<(...args: any[]) => any>;
        onOpen: PropTypes.Requireable<(...args: any[]) => any>;
        open: PropTypes.Requireable<boolean>;
        overlay: (props: Record<string, any>, propName: string, componentName: string, ...args: any[]) => any;
    ...
    static Footer: {
        ...
        create: import("../../lib").ShorthandFactory<DialogFooterProps>;
    ...
    overlayRef: React.MutableRefObject<HTMLElement>;
    ...
    handleDialogCancel: (e: Event | React.SyntheticEvent<Element, Event>) => void;
    handleDialogConfirm: (e: React.SyntheticEvent<Element, Event>) => void;
    handleDialogOpen: (e: React.SyntheticEvent<Element, Event>) => void;
...
declare const _default: {
    ...
    getAutoControlledStateFromProps: typeof Dialog.getAutoControlledStateFromProps;
    unhandledProps: string[];
    _handledPropsCache: string[];
