...
declare const _default: {
    ...
    (x: {
        ...
        styles?: import("../..").ComponentSlotStyle<DropdownSearchInputProps, any>;
        variables?: any;
    ...
    create: ShorthandFactory<DropdownSearchInputProps>;
    _handledPropsCache: string[];
    slotClassNames: DropdownSearchInputSlotClassNames;
};
/**
