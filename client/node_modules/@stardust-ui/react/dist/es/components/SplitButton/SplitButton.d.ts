...
import { WithAsProp, ComponentEventHandler, ShorthandValue, ShorthandCollection } from '../../types';
import { UIComponentProps, ChildrenComponentProps, ContentComponentProps, AutoControlledComponent, RenderResultConfig, ShorthandFactory } from '../../lib';
...
declare class SplitButton extends AutoControlledComponent<WithAsProp<SplitButtonProps>, SplitButtonState> {
    static create: ShorthandFactory<SplitButton>;
    static displayName: string;
    static className: string;
    static slotClassNames: SplitButtonSlotClassNames;
    static propTypes: {
        button: (props: Record<string, any>, propName: string, componentName: string, ...args: any[]) => any;
        defaultOpen: PropTypes.Requireable<boolean>;
        menu: PropTypes.Requireable<{}>;
        onMainButtonClick: PropTypes.Requireable<(...args: any[]) => any>;
        onMenuItemClick: PropTypes.Requireable<(...args: any[]) => any>;
        onOpenChange: PropTypes.Requireable<(...args: any[]) => any>;
        open: PropTypes.Requireable<boolean>;
        primary: (props: Record<string, any>, propName: string, componentName: string, ...args: any[]) => any;
        secondary: (props: Record<string, any>, propName: string, componentName: string, ...args: any[]) => any;
        toggleButton: (props: Record<string, any>, propName: string, componentName: string, ...args: any[]) => any;
    ...
    handleMenuButtonOverrides: (predefinedProps: MenuButtonProps) => {
        onMenuItemClick: (e: React.SyntheticEvent<Element, Event>, menuItemProps: MenuItemProps) => void;
        onOpenChange: (e: React.SyntheticEvent<Element, Event>, popupProps: PopupProps) => void;
    };
    handleMenuButtonTriggerOverrides: (predefinedProps: ButtonProps) => {
        onClick: (e: React.SyntheticEvent<Element, Event>, buttonProps: ButtonProps) => void;
        onFocus: (e: React.SyntheticEvent<Element, Event>, buttonProps: ButtonProps) => void;
    };
    renderComponent({ ElementType, classes, accessibility, styles, unhandledProps, }: RenderResultConfig<MenuButtonProps>): React.ReactNode;
}
declare const _default: {
    ...
    (x: {
        ...
        defaultOpen?: boolean;
        disabled?: boolean;
        menu?: string | number | boolean | React.ReactElement<any, string | ((props: any) => React.ReactElement<any, string | any | (new (props: any) => React.Component<any, any, any>)>) | (new (props: any) => React.Component<any, any, any>)> | React.ReactNodeArray | React.ReactPortal | import("../../types").Props<MenuProps> | ShorthandValue<MenuItemProps & {
            kind?: never;
        }>[];
        onMainButtonClick?: ComponentEventHandler<ButtonProps>;
        onMenuItemClick?: ComponentEventHandler<MenuItemProps>;
    ...
    create: ShorthandFactory<SplitButton>;
    _handledPropsCache: string[];
    slotClassNames: SplitButtonSlotClassNames;
};
/**
