...
import { UIComponentProps, ChildrenComponentProps, ContentComponentProps, ShorthandFactory } from '../../lib';
...
declare const _default: {
    <Tag>(x: {
        as: Tag; /** A message can format the reactions group to appear at the start or the end of the message. */
    } & ChatMessageProps & {
        [K: string]: any;
    }): JSX.Element;
    (x: {
        accessibility?: Accessibility<any>;
        actionMenu?: string | number | boolean | React.ReactElement<any, string | ((props: any) => React.ReactElement<any, string | any | (new (props: any) => React.Component<any, any, any>)>) | (new (props: any) => React.Component<any, any, any>)> | React.ReactNodeArray | React.ReactPortal | import("../../types").Props<MenuProps> | ShorthandValue<MenuItemProps & {
            kind?: never;
        }>[];
        attached?: boolean | "top" | "bottom";
        author?: ShorthandValue<TextProps>;
        ...
        onMouseEnter?: ComponentEventHandler<ChatMessageProps>;
        positionActionMenu?: boolean;
        reactionGroup?: string | number | boolean | React.ReactElement<any, string | ((props: any) => React.ReactElement<any, string | any | (new (props: any) => React.Component<any, any, any>)>) | (new (props: any) => React.Component<any, any, any>)> | React.ReactNodeArray | React.ReactPortal | ShorthandValue<ReactionProps & {
            kind?: never;
        }>[] | import("../../types").Props<ReactionGroupProps>;
        reactionGroupPosition?: "start" | "end";
        unstable_overflow?: boolean;
        className?: string;
        design?: import("../../themes/types").ComponentDesign;
        styles?: import("../../themes/types").ComponentSlotStyle<any, any>;
        variables?: any;
        animation?: import("../../themes/types").AnimationProp;
    ...
    isTypeOfElement: (element: any) => any;
};
/**
