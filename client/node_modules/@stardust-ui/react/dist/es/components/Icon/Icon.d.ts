...
import { UIComponentProps, ColorComponentProps, SizeValue, ShorthandFactory } from '../../lib';
export declare type IconXSpacing = 'none' | 'before' | 'after' | 'both';
...
declare const _default: {
    ...
    create: ShorthandFactory<IconProps>;
