...
import { ComponentVariablesInput, ComponentSlotStyle, AnimationProp, ComponentDesign } from '../themes/types';
...
export interface UIComponentProps<P = any, V = any> extends StyledComponentProps<P, V>, AnimatedComponentProps {
