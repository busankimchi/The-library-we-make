...
var thumbFromPreviousSiblingSelector = "&+ .".concat(Slider.slotClassNames.thumb);
...
var sliderStyles = {
  ...
  input: function input(_ref2) {
    ...
    return Object.assign((_Object$assign = {
      ...
      padding: 0,
      opacity: 0
    }, _defineProperty(_Object$assign, selectors.WEBKIT_THUMB, Object.assign({}, thumbStyles, {
      '-webkit-appearance': 'none'
    })), _defineProperty(_Object$assign, selectors.MOZ_THUMB, thumbStyles), _defineProperty(_Object$assign, selectors.MS_THUMB, Object.assign({}, thumbStyles, {
      marginTop: "calc(-".concat(v.thumbHeight, " / 2)")
    })), _defineProperty(_Object$assign, selectors.MS_FILL_LOWER, {
      display: 'none'
    }), _defineProperty(_Object$assign, selectors.MS_FILL_UPPER, {
      display: 'none'
    }), _Object$assign), getFluidStyles(p), {
      ':active': _defineProperty({}, thumbFromPreviousSiblingSelector, activeThumbStyles),
      ':focus': _defineProperty({
        outline: 0
      }, thumbFromPreviousSiblingSelector, borderFocusStyles[':focus']),
      ':focus-visible': _defineProperty({}, thumbFromPreviousSiblingSelector, Object.assign({}, borderFocusStyles[':focus-visible'], activeThumbStyles))
    });
  },
