...
export default {
  // EXPORTS
  processedIcons_zoomout: processedIcons_zoomout,
  processedIcons_zoomin: processedIcons_zoomin,
  processedIcons_zip: processedIcons_zip,
  processedIcons_youtube: processedIcons_youtube,
  processedIcons_yammer: processedIcons_yammer,
  processedIcons_whiteboard: processedIcons_whiteboard,
  processedIcons_website: processedIcons_website,
  processedIcons_waffle: processedIcons_waffle,
  processedIcons_voicemail: processedIcons_voicemail,
  processedIcons_videooff: processedIcons_videooff,
  processedIcons_video: processedIcons_video,
  processedIcons_urgent: processedIcons_urgent,
  processedIcons_unfollowchannel: processedIcons_unfollowchannel,
  processedIcons_undo: processedIcons_undo,
  processedIcons_underline: processedIcons_underline,
  processedIcons_txt: processedIcons_txt,
  processedIcons_triangleupsmall: processedIcons_triangleupsmall,
  processedIcons_trianglerightsmall: processedIcons_trianglerightsmall,
  processedIcons_triangledownsmall: processedIcons_triangledownsmall,
  processedIcons_trianglediagonalrightsmall: processedIcons_trianglediagonalrightsmall,
  processedIcons_trending: processedIcons_trending,
  processedIcons_trashcan: processedIcons_trashcan,
  processedIcons_translation: processedIcons_translation,
  processedIcons_timezonenight: processedIcons_timezonenight,
  processedIcons_timezoneday: processedIcons_timezoneday,
  processedIcons_tentative: processedIcons_tentative,
  processedIcons_teams: processedIcons_teams,
  processedIcons_teamdiscover: processedIcons_teamdiscover,
  processedIcons_teamcreate: processedIcons_teamcreate,
  processedIcons_tabledelete: processedIcons_tabledelete,
  processedIcons_tableadd: processedIcons_tableadd,
  processedIcons_table: processedIcons_table,
  processedIcons_tabbadge: processedIcons_tabbadge,
  processedIcons_strike: processedIcons_strike,
  processedIcons_sticker: processedIcons_sticker,
  processedIcons_statusyo: processedIcons_statusyo,
  processedIcons_starred: processedIcons_starred,
  processedIcons_star: processedIcons_star,
  processedIcons_speakerslashed: processedIcons_speakerslashed,
  processedIcons_speakeroff: processedIcons_speakeroff,
  processedIcons_speakermute: processedIcons_speakermute,
  processedIcons_snooze: processedIcons_snooze,
  processedIcons_sketch: processedIcons_sketch,
  processedIcons_shareobject: processedIcons_shareobject,
  processedIcons_share: processedIcons_share,
  processedIcons_sfbviewbox32: processedIcons_sfbviewbox32,
  processedIcons_settings: processedIcons_settings,
  processedIcons_send: processedIcons_send,
  processedIcons_search: processedIcons_search,
  processedIcons_screenzoomout: processedIcons_screenzoomout,
  processedIcons_screenzoomin: processedIcons_screenzoomin,
  processedIcons_roster: processedIcons_roster,
  processedIcons_retry: processedIcons_retry,
  processedIcons_resetzoom: processedIcons_resetzoom,
  processedIcons_reply: processedIcons_reply,
  processedIcons_removeFormat: processedIcons_removeFormat,
  processedIcons_refresh: processedIcons_refresh,
  processedIcons_redo: processedIcons_redo,
  processedIcons_redbang: processedIcons_redbang,
  processedIcons_recurrence: processedIcons_recurrence,
  processedIcons_recents: processedIcons_recents,
  processedIcons_recent: processedIcons_recent,
  processedIcons_readaloud: processedIcons_readaloud,
  processedIcons_quote: processedIcons_quote,
  processedIcons_quickresponse: processedIcons_quickresponse,
  processedIcons_qna: processedIcons_qna,
  processedIcons_presenceAvailable: processedIcons_presenceAvailable,
  processedIcons_presenceStroke: processedIcons_presenceStroke,
  processedIcons_promoted: processedIcons_promoted,
  processedIcons_pluscircled: processedIcons_pluscircled,
  processedIcons_playpause: processedIcons_playpause,
  processedIcons_playforward: processedIcons_playforward,
  processedIcons_play: processedIcons_play,
  processedIcons_pin: processedIcons_pin,
  processedIcons_person: processedIcons_person,
  processedIcons_pdf: processedIcons_pdf,
  processedIcons_pcaudiostop: processedIcons_pcaudiostop,
  processedIcons_pcaudio: processedIcons_pcaudio,
  processedIcons_patharrow: processedIcons_patharrow,
  processedIcons_paste: processedIcons_paste,
  processedIcons_participantremove: processedIcons_participantremove,
  processedIcons_outline: processedIcons_outline,
  processedIcons_outdent: processedIcons_outdent,
  processedIcons_orgwide: processedIcons_orgwide,
  processedIcons_org: processedIcons_org,
  processedIcons_openoutside: processedIcons_openoutside,
  processedIcons_opennewwindowfilled: processedIcons_opennewwindowfilled,
  processedIcons_opennewwindow: processedIcons_opennewwindow,
  processedIcons_openinsidesmall: processedIcons_openinsidesmall,
  processedIcons_openinside: processedIcons_openinside,
  processedIcons_openexternallinkoff: processedIcons_openexternallinkoff,
  processedIcons_oof: processedIcons_oof,
  processedIcons_onenotesection: processedIcons_onenotesection,
  processedIcons_numberlist: processedIcons_numberlist,
  processedIcons_notificationoff: processedIcons_notificationoff,
  processedIcons_notes: processedIcons_notes,
  processedIcons_nochat: processedIcons_nochat,
  processedIcons_newtab: processedIcons_newtab,
  processedIcons_newcontactgroup: processedIcons_newcontactgroup,
  processedIcons_myactivity: processedIcons_myactivity,
  processedIcons_mutechat: processedIcons_mutechat,
  processedIcons_msftxlonline: processedIcons_msftxlonline,
  processedIcons_msftxl: processedIcons_msftxl,
  processedIcons_msftwordonline: processedIcons_msftwordonline,
  processedIcons_msftword: processedIcons_msftword,
  processedIcons_msftvisio: processedIcons_msftvisio,
  processedIcons_msftteams: processedIcons_msftteams,
  processedIcons_msftstream: processedIcons_msftstream,
  processedIcons_msftspdoclibrary: processedIcons_msftspdoclibrary,
  processedIcons_msftsharepoint: processedIcons_msftsharepoint,
  processedIcons_msftpptonline: processedIcons_msftpptonline,
  processedIcons_msftppt: processedIcons_msftppt,
  processedIcons_msftpowerbi: processedIcons_msftpowerbi,
  processedIcons_msftplanner: processedIcons_msftplanner,
  processedIcons_msftoutlookcolored: processedIcons_msftoutlookcolored,
  processedIcons_msftoutlook: processedIcons_msftoutlook,
  processedIcons_msftonenoteonline: processedIcons_msftonenoteonline,
  processedIcons_msftonenote: processedIcons_msftonenote,
  processedIcons_msftonedrive: processedIcons_msftonedrive,
  processedIcons_msftoffice: processedIcons_msftoffice,
  processedIcons_msftexchange: processedIcons_msftexchange,
  processedIcons_msftdelve: processedIcons_msftdelve,
  processedIcons_msftcanvas: processedIcons_msftcanvas,
  processedIcons_move: processedIcons_move,
  processedIcons_mov: processedIcons_mov,
  processedIcons_more: processedIcons_more,
  processedIcons_micoff: processedIcons_micoff,
  processedIcons_mic: processedIcons_mic,
  processedIcons_menulight: processedIcons_menulight,
  processedIcons_menu: processedIcons_menu,
  processedIcons_mention: processedIcons_mention,
  processedIcons_megaphone: processedIcons_megaphone,
  processedIcons_meetingnotes: processedIcons_meetingnotes,
  processedIcons_meetingnew: processedIcons_meetingnew,
  processedIcons_mediaoff: processedIcons_mediaoff,
  processedIcons_messageSeen: processedIcons_messageSeen,
  processedIcons_markasunread: processedIcons_markasunread,
  processedIcons_markasread: processedIcons_markasread,
  processedIcons_manageteams: processedIcons_manageteams,
  processedIcons_lock18: processedIcons_lock18,
  processedIcons_lock14: processedIcons_lock14,
  processedIcons_lock: processedIcons_lock,
  processedIcons_locationoff: processedIcons_locationoff,
  processedIcons_location: processedIcons_location,
  processedIcons_link: processedIcons_link,
  processedIcons_liked: processedIcons_liked,
  processedIcons_like: processedIcons_like,
  processedIcons_leave: processedIcons_leave,
  processedIcons_kollective: processedIcons_kollective,
  processedIcons_keyboard: processedIcons_keyboard,
  processedIcons_italic: processedIcons_italic,
  processedIcons_invitetentative: processedIcons_invitetentative,
  processedIcons_inviteperson: processedIcons_inviteperson,
  processedIcons_invitenotresponded: processedIcons_invitenotresponded,
  processedIcons_invitedeclined: processedIcons_invitedeclined,
  processedIcons_invitecancelled: processedIcons_invitecancelled,
  processedIcons_inviteaccepted: processedIcons_inviteaccepted,
  processedIcons_inputvalid: processedIcons_inputvalid,
  processedIcons_inputinvalid: processedIcons_inputinvalid,
  processedIcons_info: processedIcons_info,
  processedIcons_inferred: processedIcons_inferred,
  processedIcons_indicator: processedIcons_indicator,
  processedIcons_indent: processedIcons_indent,
  processedIcons_image: processedIcons_image,
  processedIcons_horizontalrule: processedIcons_horizontalrule,
  processedIcons_home: processedIcons_home,
  processedIcons_hive: processedIcons_hive,
  processedIcons_highlight: processedIcons_highlight,
  processedIcons_helparticle: processedIcons_helparticle,
  processedIcons_headset: processedIcons_headset,
  processedIcons_hand: processedIcons_hand,
  processedIcons_groups: processedIcons_groups,
  processedIcons_giphy: processedIcons_giphy,
  processedIcons_gif: processedIcons_gif,
  processedIcons_gettingstarted: processedIcons_gettingstarted,
  processedIcons_gallery: processedIcons_gallery,
  processedIcons_fullscreen: processedIcons_fullscreen,
  processedIcons_format: processedIcons_format,
  processedIcons_fontsize: processedIcons_fontsize,
  processedIcons_fontcolor: processedIcons_fontcolor,
  processedIcons_followchannel: processedIcons_followchannel,
  processedIcons_folderupload: processedIcons_folderupload,
  processedIcons_foldernew: processedIcons_foldernew,
  processedIcons_folderdownload: processedIcons_folderdownload,
  processedIcons_folder: processedIcons_folder,
  processedIcons_filter: processedIcons_filter,
  processedIcons_filesuploadsmall: processedIcons_filesuploadsmall,
  processedIcons_filesupload: processedIcons_filesupload,
  processedIcons_filessound: processedIcons_filessound,
  processedIcons_filesphotoshop: processedIcons_filesphotoshop,
  processedIcons_filesmissing: processedIcons_filesmissing,
  processedIcons_fileslink: processedIcons_fileslink,
  processedIcons_filesindesign: processedIcons_filesindesign,
  processedIcons_filesillustrator: processedIcons_filesillustrator,
  processedIcons_filesflash: processedIcons_filesflash,
  processedIcons_fileserrorfull: processedIcons_fileserrorfull,
  processedIcons_filesdocument: processedIcons_filesdocument,
  processedIcons_filesaftereffects: processedIcons_filesaftereffects,
  processedIcons_files: processedIcons_files,
  processedIcons_feedback: processedIcons_feedback,
  processedIcons_faq: processedIcons_faq,
  processedIcons_eyeslash: processedIcons_eyeslash,
  processedIcons_eyefriendlier: processedIcons_eyefriendlier,
  processedIcons_eye: processedIcons_eye,
  processedIcons_expand: processedIcons_expand,
  processedIcons_error: processedIcons_error,
  processedIcons_emoji: processedIcons_emoji,
  processedIcons_email: processedIcons_email,
  processedIcons_edit: processedIcons_edit,
  processedIcons_dropdown: processedIcons_dropdown,
  processedIcons_downloaded: processedIcons_downloaded,
  processedIcons_download: processedIcons_download,
  processedIcons_document: processedIcons_document,
  processedIcons_desktop: processedIcons_desktop,
  processedIcons_cortana: processedIcons_cortana,
  processedIcons_copy: processedIcons_copy,
  processedIcons_contactlist: processedIcons_contactlist,
  processedIcons_connectorbadge: processedIcons_connectorbadge,
  processedIcons_composeextmenuitem: processedIcons_composeextmenuitem,
  processedIcons_composeextensionunpin: processedIcons_composeextensionunpin,
  processedIcons_composeextensionpin: processedIcons_composeextensionpin,
  processedIcons_compose: processedIcons_compose,
  processedIcons_collapse: processedIcons_collapse,
  processedIcons_codesnippet: processedIcons_codesnippet,
  processedIcons_code: processedIcons_code,
  processedIcons_closedcaption: processedIcons_closedcaption,
  processedIcons_close: processedIcons_close,
  processedIcons_chromeunmaximize: processedIcons_chromeunmaximize,
  processedIcons_chromeminimize: processedIcons_chromeminimize,
  processedIcons_chromemaximize: processedIcons_chromemaximize,
  processedIcons_chevronright: processedIcons_chevronright,
  processedIcons_chevronmedright: processedIcons_chevronmedright,
  processedIcons_chevronmedleft: processedIcons_chevronmedleft,
  processedIcons_chevronleft: processedIcons_chevronleft,
  processedIcons_chevrondown: processedIcons_chevrondown,
  processedIcons_checkboxunselected: processedIcons_checkboxunselected,
  processedIcons_checkboxselected: processedIcons_checkboxselected,
  processedIcons_chat: processedIcons_chat,
  processedIcons_channelicon: processedIcons_channelicon,
  processedIcons_changename: processedIcons_changename,
  processedIcons_canvasaddpage: processedIcons_canvasaddpage,
  processedIcons_callvideolineoff: processedIcons_callvideolineoff,
  processedIcons_callvideoline: processedIcons_callvideoline,
  processedIcons_callvideofilled: processedIcons_callvideofilled,
  processedIcons_callvideo: processedIcons_callvideo,
  processedIcons_calltransfernotification: processedIcons_calltransfernotification,
  processedIcons_calltransfer: processedIcons_calltransfer,
  processedIcons_callswitchcamera: processedIcons_callswitchcamera,
  processedIcons_callrecording: processedIcons_callrecording,
  processedIcons_callpstnfull: processedIcons_callpstnfull,
  processedIcons_callpstn: processedIcons_callpstn,
  processedIcons_callparticipantonhold: processedIcons_callparticipantonhold,
  processedIcons_callparticipantincomingline: processedIcons_callparticipantincomingline,
  processedIcons_callparticipantincoming: processedIcons_callparticipantincoming,
  processedIcons_callparticipantfailed: processedIcons_callparticipantfailed,
  processedIcons_callparticipantending: processedIcons_callparticipantending,
  processedIcons_callparticipantconnectingline: processedIcons_callparticipantconnectingline,
  processedIcons_callparticipantconnecting: processedIcons_callparticipantconnecting,
  processedIcons_callparticipantconnected: processedIcons_callparticipantconnected,
  processedIcons_callmissedline: processedIcons_callmissedline,
  processedIcons_callmissed: processedIcons_callmissed,
  processedIcons_callmicrophoneunmuting: processedIcons_callmicrophoneunmuting,
  processedIcons_callmicrophoneofffilled: processedIcons_callmicrophoneofffilled,
  processedIcons_callmeetupline: processedIcons_callmeetupline,
  processedIcons_callincomingvideo: processedIcons_callincomingvideo,
  processedIcons_callhold: processedIcons_callhold,
  processedIcons_callend: processedIcons_callend,
  processedIcons_calldialpad: processedIcons_calldialpad,
  processedIcons_callcontrolrelease: processedIcons_callcontrolrelease,
  processedIcons_callcontrolrequest: processedIcons_callcontrolrequest,
  processedIcons_callcontrolstoppresentingnew: processedIcons_callcontrolstoppresentingnew,
  processedIcons_callcontrolpresentnew: processedIcons_callcontrolpresentnew,
  processedIcons_callblocked: processedIcons_callblocked,
  processedIcons_callaudio: processedIcons_callaudio,
  processedIcons_callalert: processedIcons_callalert,
  processedIcons_calladmitall: processedIcons_calladmitall,
  processedIcons_call: processedIcons_call,
  processedIcons_calendar: processedIcons_calendar,
  processedIcons_bullets: processedIcons_bullets,
  processedIcons_broadcast: processedIcons_broadcast,
  processedIcons_broadcastviewright: processedIcons_broadcastviewright,
  processedIcons_broadcastviewleft: processedIcons_broadcastviewleft,
  processedIcons_broadcastviewfullscreen: processedIcons_broadcastviewfullscreen,
  processedIcons_bot: processedIcons_bot,
  processedIcons_bookmark: processedIcons_bookmark,
  processedIcons_bold: processedIcons_bold,
  processedIcons_blurbackground: processedIcons_blurbackground,
  processedIcons_block: processedIcons_block,
  processedIcons_bellmute: processedIcons_bellmute,
  processedIcons_bell: processedIcons_bell,
  processedIcons_badgeadd: processedIcons_badgeadd,
  processedIcons_badge: processedIcons_badge,
  processedIcons_backspace: processedIcons_backspace,
  processedIcons_audio: processedIcons_audio,
  processedIcons_attachment: processedIcons_attachment,
  processedIcons_assignments: processedIcons_assignments,
  processedIcons_arrowupsmall: processedIcons_arrowupsmall,
  processedIcons_arrowup: processedIcons_arrowup,
  processedIcons_arrowright: processedIcons_arrowright,
  processedIcons_arrowleft: processedIcons_arrowleft,
  processedIcons_arrowdown: processedIcons_arrowdown,
  processedIcons_archive: processedIcons_archive,
  processedIcons_apps: processedIcons_apps,
  processedIcons_analytics: processedIcons_analytics,
  processedIcons_addparticipant: processedIcons_addparticipant,
  processedIcons_add: processedIcons_add,
  processedIcons_accept: processedIcons_accept
};